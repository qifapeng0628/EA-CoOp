...
class BACH(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "BACH")
        ...
        if os.path.exists(self.split_path):
            ...
            # Optional: rename folder names into cleaner prompts (edit if you want)
            # Example: {"InSitu": "in situ carcinoma", "In_Situ": "in situ carcinoma"}
            new_cnames = None
