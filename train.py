...
sys.path.append(os.path.join(os.path.dirname(__file__), "MedSAM"))
...
import trainers.MedgazeCoOp.medgazecoop_biomedclip
import trainers.MedgazeCoOp.medgazecoop_clip
import trainers.MedgazeCoOp.medgazecoop_pubmedclip
import trainers.MedgazeCoOp.medgazecoop_pmcclip
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.MEDGAZECOOP = CN()
    cfg.TRAINER.MEDGAZECOOP.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.MEDGAZECOOP.CSC = False  # class-specific context
    cfg.TRAINER.MEDGAZECOOP.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
    cfg.TRAINER.MEDGAZECOOP.N_CTX = 4  # number of context vectors
    cfg.TRAINER.MEDGAZECOOP.PREC = "fp32"  # fp16, fp32, amp
    cfg.TRAINER.MEDGAZECOOP.N_PROMPTS = 20
