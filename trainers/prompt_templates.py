...
BIOMEDCOOP_TEMPLATES = {
  ...
  "breast normal tissue": [
    "Histopathology image showing well-organized lobular structures with distinct ductal architecture",
    "Normal breast tissue displaying a clear double layer of luminal and myoepithelial cells",
    "Well-preserved terminal duct lobular units (TDLU) with minimal cellular pleomorphism",
    "Orderly arrangement of epithelial cells within ducts surrounded by loose specialized stroma",
    "Breast tissue section showing regular nuclear morphology and low nuclear-to-cytoplasmic ratio",
    "Normal histology with no evidence of epithelial hyperplasia or stromal invasion",
    "Clear separation between glandular elements and the surrounding interlobular fibrous tissue",
    "Ductal structures with intact basement membranes and uniform cell distribution",
    "Normal mammary glands with quiescent appearance and absence of mitotic figures",
    "Histological slide showing balanced distribution of adipose and glandular breast tissue",
    "Regular epithelial lining in small ducts with no signs of atypia or crowding",
    "Stable stromal environment with typical collagen fiber distribution around normal ducts",
    "Small, uniform nuclei with smooth borders in the epithelial layer of the breast",
    "Absence of inflammatory cell infiltration in the normal breast parenchyma",
    "Well-defined acini within the lobules showing a single layer of secretory cells",
    "Consistent chromatin pattern in the nuclei of normal breast epithelial cells",
    "Preserved architecture of the mammary tree with typical branching patterns",
    "Clear luminal spaces within the ducts with no intraluminal cellular debris",
    "Normal breast stroma containing spindled fibroblasts with regular spacing",
    "Microscopic view of healthy breast tissue with no signs of structural distortion",
    "Thin, delicate basement membrane supporting a healthy bilayered epithelium",
    "Normal glandular units showing no evidence of architectural overcrowding",
    "Homogeneous appearance of the connective tissue surrounding healthy breast lobules",
    "Breast parenchyma showing typical physiological morphology with no pathological lesions",
    "Regular distribution of interlobular and intralobular stroma in normal tissue",
    "Normal lobular units with discrete margins and no cellular infiltration into fat",
    "Standard ductal anatomy with no papillary projections or solid growth patterns",
    "Healthy breast epithelium showing clear differentiation and low metabolic activity",
    "Orderly stromal collagen with no signs of desmoplastic reaction",
    "Uniform and small nucleoli in the cells of the normal breast ductal system",
    "Microscopic section showing intact and regular specialized intraluminal stroma",
    "Normal breast tissue with no signs of microcalcifications or architectural distortion",
    "Quiet mammary epithelium with minimal variations in cell size and shape",
    "Typical arrangement of myoepithelial cells at the periphery of normal ducts",
    "Well-organized breast lobules showing regular acinar spacing",
    "Normal tissue architecture with absence of any proliferative or neoplastic changes",
    "Clear and distinct cell borders in the healthy mammary ductal epithelium",
    "Uniform nuclear density across the normal breast tissue section",
    "Standard lobular morphology with no signs of epithelial cell doubling or piling",
    "Histopathology displaying healthy adipocytes interspersed with regular glandular units",
    "Normal stromal-epithelial relationship with no signs of tissue remodeling",
    "Symmetrical ductal cross-sections with no evidence of lumen compression",
    "Smooth and continuous epithelial lining in normal breast ducts",
    "Typical connective tissue density in the interlobular spaces of normal breast",
    "Absence of large pleomorphic cells in the normal breast glandular structures",
    "Uniform and fine chromatin distribution in the nuclei of normal cells",
    "Breast tissue showing healthy cellular maturation and regular layering",
    "Normal lobular configuration with no signs of ductal ectasia or expansion",
    "Histological view of quiescent breast tissue with no signs of atypical hyperplasia",
    "Clear and well-defined ductal units with typical histological markers of health"
  ],
  "breast benign lesion": [
    "Histopathology showing benign epithelial hyperplasia with maintained ductal architecture",
    "Presence of fibroadenoma features with elongated and compressed ductal spaces",
    "Benign breast lesion displaying a proliferation of both glandular and stromal elements",
    "Increased cellularity within the lobules but with well-differentiated cell types",
    "Sclerosing adenosis showing an increased number of acini with intact basement membranes",
    "Benign lesion with regular cell spacing and absence of significant nuclear atypia",
    "Well-circumscribed lesion showing fibrocollagenous stroma and regular ducts",
    "Intraductal papilloma featuring fibrovascular cores lined by a double cell layer",
    "Benign proliferative changes with no signs of basement membrane penetration",
    "Presence of apocrine metaplasia in the lining of a benign breast cyst",
    "Typical ductal hyperplasia showing irregular luminal fenestrations",
    "Benign lesion with uniform nuclear size and low mitotic rate",
    "Hyperplastic ducts showing a streaming pattern of benign epithelial cells",
    "Stromal fibrosis and glandular crowding consistent with a benign condition",
    "Preserved lobular architecture despite the presence of benign cellular proliferation",
    "Benign breast tissue showing ductal ectasia with intraluminal secretions",
    "Well-defined borders of a benign lesion separating it from normal tissue",
    "Presence of microcalcifications within a benign fibrocystic change",
    "Benign growth pattern with no evidence of irregular stromal infiltration",
    "Ductal structures showing mild epithelial hyperplasia without cellular atypia",
    "Benign stromal proliferation with characteristic slit-like ductal spaces",
    "Presence of myoepithelial cells confirmed at the periphery of benign ducts",
    "Regular and organized cellular growth within a benign breast nodule",
    "Benign breast lesion showing no signs of necrosis or rapid cell division",
    "Consistent cellular morphology across the benign hyperplastic areas",
    "Fibrous stroma with low cellularity surrounding benign glandular elements",
    "Benign lesion displaying typical columnar cell changes in the ductal lining",
    "Architecture showing blunt duct adenosis with preserved cellular layers",
    "Absence of pleomorphic nuclei in a benign proliferative breast lesion",
    "Well-differentiated glandular structures within a benign breast tumor",
    "Benign histology with clear separation of epithelial and stromal compartments",
    "Proliferation of small ducts in a benign pattern of sclerosing adenosis",
    "Histopathology showing a benign fibroepithelial lesion with regular margins",
    "Normal-appearing nuclei despite the increase in ductal density in benign lesions",
    "Benign ductal hyperplasia with characteristic 'cookie-cutter' like spaces",
    "Consistent and benign-appearing epithelial cells lining the cysts",
    "Clear and organized fibrous capsule surrounding a benign breast lesion",
    "Absence of invasive growth patterns in a benign histological section",
    "Benign epithelial cells with small, uniform nucleoli and regular borders",
    "Orderly expansion of breast lobules in a benign proliferative process",
    "Benign lesion featuring prominent myoepithelial layers and no infiltration",
    "Microscopic view of a benign lesion with minimal architectural distortion",
    "Benign breast stroma showing regular collagen bundles and few fibroblasts",
    "Benign proliferation of ducts with maintained polarity of epithelial cells",
    "Clear and distinct luminal architecture within a benign breast lesion",
    "Histology showing benign adenosis with no signs of malignancy",
    "Benign lesion displaying a harmonious growth of stroma and epithelium",
    "Presence of typical foam cells in a benign breast cyst aspirate area",
    "Well-organized stromal cells with no signs of malignant transformation",
    "Benign breast tissue with moderate hyperplasia and no evidence of cancer"
  ],
  "breast in situ carcinoma": [
    "Ductal carcinoma in situ (DCIS) showing malignant cells confined within the duct",
    "In situ carcinoma featuring a cribriform growth pattern with rigid lumens",
    "High-grade DCIS with prominent central comedo-type necrosis",
    "Malignant epithelial proliferation without penetration of the basement membrane",
    "In situ lesion showing pleomorphic nuclei and frequent mitotic figures",
    "Ductal expansion by a monomorphic population of atypical epithelial cells",
    "Solid growth pattern of malignant cells within the breast ductal system",
    "In situ carcinoma with micropapillary architecture and cellular atypia",
    "Presence of calcifications within the necrotic centers of in situ ducts",
    "Distended ducts filled with atypical cells but with intact peripheral layers",
    "Carcinoma in situ showing loss of cell polarity within the ductal walls",
    "Nuclear pleomorphism and hyperchromasia within a localized in situ lesion",
    "In situ carcinoma displaying a localized and non-invasive growth pattern",
    "Atypical cells with prominent nucleoli confined to the breast lobules",
    "In situ lesion with sharply defined margins against the surrounding stroma",
    "Cribriform DCIS with uniform, round spaces between malignant cells",
    "In situ carcinoma showing extensive ductal involvement but no infiltration",
    "Malignant cells in DCIS showing increased nuclear-to-cytoplasmic ratio",
    "High-grade in situ lesion with large, irregular nuclei and coarse chromatin",
    "In situ carcinoma with a characteristic solid architectural pattern",
    "Intact myoepithelial layer at the periphery of ducts containing in situ carcinoma",
    "Atypical cellular proliferation showing bridging across the ductal lumen",
    "DCIS with comedo necrosis and periductal inflammatory response",
    "Carcinoma in situ with prominent cellular crowding and lack of differentiation",
    "Localized malignant growth within the breast epithelium with no stromal breach",
    "Microscopic evidence of in situ carcinoma showing atypical mitotic figures",
    "Ductal carcinoma in situ with a clinging or flat architectural pattern",
    "In situ lesion showing varied nuclear grades but no signs of invasion",
    "Atypical cells forming secondary lumens in a cribriform in situ pattern",
    "Presence of high-grade nuclei within the confined spaces of DCIS",
    "In situ carcinoma with well-preserved ductal boundaries despite malignancy",
    "Marked cellular atypia in the ductal lining without stromal involvement",
    "In situ carcinoma displaying rigid and geometric cellular arrangements",
    "Ducts containing in situ carcinoma showing significant expansion and distortion",
    "Malignant cells in DCIS showing loss of cohesion within the duct",
    "In situ carcinoma with a papillary growth pattern and atypical nuclei",
    "Clear evidence of intraepithelial neoplasia without basement membrane disruption",
    "High nuclear grade DCIS with abundant eosinophilic cytoplasm in cells",
    "In situ lesion showing a mixture of solid and cribriform patterns",
    "Carcinoma in situ with microcalcifications localized to the ductal lumens",
    "Atypical epithelial cells showing prominent macronucleoli in an in situ lesion",
    "Localized carcinoma in situ with no evidence of individual cell infiltration",
    "In situ growth showing a distinct lack of normal double cell layering",
    "DCIS with architectural complexity but confined to the original ductal tree",
    "Malignant nuclear features within a strictly intra-ductal proliferation",
    "In situ carcinoma showing uniform population of atypical cells within ducts",
    "Significant nuclear pleomorphism in cells confined by the basement membrane",
    "Ductal carcinoma in situ displaying a high degree of architectural atypia",
    "Absence of stromal reaction despite the presence of malignant cells in ducts",
    "In situ carcinoma with clear cellular atypia and maintained tissue barriers"
  ],
  "breast invasive carcinoma": [
    "Invasive ductal carcinoma showing irregular nests of cells infiltrating the stroma",
    "Malignant cells breaking through the basement membrane into the surrounding tissue",
    "Invasive carcinoma featuring cords and clusters of highly pleomorphic cells",
    "Pronounced desmoplastic reaction in the stroma surrounding invasive nests",
    "High-grade invasive carcinoma with significant nuclear atypia and mitoses",
    "Infiltrative growth pattern with malignant cells disrupting the normal architecture",
    "Invasive carcinoma showing single-cell infiltration into the breast stroma",
    "Loss of glandular structure with replacement by solid sheets of malignant cells",
    "Presence of lymphovascular invasion by malignant breast epithelial cells",
    "Invasive carcinoma with irregular, spiculated margins infiltrating adipose tissue",
    "Marked pleomorphism and hyperchromatic nuclei in invasive cell clusters",
    "Invasive growth showing destruction of normal breast lobular units",
    "Stromal infiltration by malignant cells with lack of an intact myoepithelial layer",
    "Invasive ductal carcinoma with high mitotic activity and necrotic areas",
    "Individual malignant cells forming a 'single file' pattern in invasive lobular carcinoma",
    "Disruption of the specialized stroma by invading tumor cell nests",
    "Invasive carcinoma showing varying sizes of tumor cell clusters in the stroma",
    "High nuclear-to-cytoplasmic ratio in cells of an invasive breast cancer lesion",
    "Invasive carcinoma displaying a lack of organized ductal or lobular features",
    "Presence of tumor-infiltrating lymphocytes around invasive carcinoma nests",
    "Invasive growth with malignant cells invading the surrounding fat and muscle",
    "Prominent nucleoli and coarse chromatin in the nuclei of invasive tumor cells",
    "Invasive carcinoma with jagged and ill-defined borders within the stroma",
    "Extensive desmoplasia with dense collagen fibers around invasive cell groups",
    "Invasive ductal carcinoma showing solid, syncytial growth patterns",
    "Malignant cell infiltration causing significant architectural distortion",
    "Invasive carcinoma with frequent and atypical mitotic figures in the cells",
    "Loss of cell-to-cell adhesion in invasive lobular carcinoma cells",
    "Invasive growth showing clear evidence of basement membrane penetration",
    "Atypical epithelial cells invading the interlobular fibrous tissue",
    "Invasive carcinoma with large, irregular, and hyperchromatic nuclei",
    "Formation of irregular tubular structures within an invasive carcinoma",
    "Invasive carcinoma showing extensive stromal remodeling and inflammation",
    "Presence of necrosis within the invasive tumor cell aggregates",
    "Infiltrating nests of carcinoma cells with varying degrees of differentiation",
    "Invasive carcinoma with prominent stromal infiltration and cell pleomorphism",
    "Malignant cells showing diverse shapes and sizes in the invasive front",
    "Invasive carcinoma displaying a high degree of cellular and nuclear atypia",
    "Disrupted breast tissue architecture with prominent invasive cell clusters",
    "Invasive growth pattern showing tumor cells in direct contact with stroma",
    "High-grade invasive lesion with dense, irregular cellularity and no lumens",
    "Infiltrating carcinoma cells showing loss of normal epithelial polarity",
    "Invasive carcinoma with significant nuclear enlargement and irregularity",
    "Presence of invasive nests deep within the breast adipose tissue",
    "Invasive ductal carcinoma showing a high degree of architectural chaos",
    "Malignant cells infiltrating the stroma in a diffuse and haphazard manner",
    "Invasive carcinoma with prominent nucleoli and irregular nuclear membranes",
    "Infiltrating cords of tumor cells causing structural collapse of normal ducts",
    "Invasive carcinoma showing extensive involvement of the peritumoral stroma",
    "Malignant growth with clear evidence of aggressive tissue infiltration"
  ]
