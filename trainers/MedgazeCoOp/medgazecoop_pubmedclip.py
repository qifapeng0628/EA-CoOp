        ...
        with torch.no_grad():
            ...
            for i in range(cfg.TRAINER.MEDGAZECOOP.N_PROMPTS):
                x_tokenized = torch.cat(
                    [clip.tokenize(MEDGAZECOOP_TEMPLATES[classname][i]) for classname in classnames]
                )
...
class MedgazeCoOp_PubMedCLIP(TrainerX):
    ...
    def build_model(self):
        ...
        print("Loading PubMedCLIP (backbone: ViT-B/32)")
